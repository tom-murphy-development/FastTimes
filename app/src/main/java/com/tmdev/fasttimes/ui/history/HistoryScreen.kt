...
private fun MonthlyStats(
    ...
    val shape1 = if (uiState.useExpressiveTheme) rememberRandomExpressiveShape(seed = monthSeed) else MaterialTheme.shapes.large
    val shape2 = if (uiState.useExpressiveTheme) rememberRandomExpressiveShape(seed = monthSeed + 1) else MaterialTheme.shapes.large
    val shape3 = if (uiState.useExpressiveTheme) rememberRandomExpressiveShape(seed = monthSeed + 2) else MaterialTheme.shapes.large
